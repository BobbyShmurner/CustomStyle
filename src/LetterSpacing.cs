            ...
            public void ModifyVertices(List<UIVertex> verts)
            {
                ...
                for (int lineIdx = 0; lineIdx < lines.Length; lineIdx++)
                {
                    ...
                    for (int charIdx = 0, actualCharIndex = 0; charIdx < line.Length; charIdx++, actualCharIndex++)
                    {
                        ...
                        int idx1 = actualCharIndex * 6 + 0;
                        int idx2 = actualCharIndex * 6 + 1;
                        int idx3 = actualCharIndex * 6 + 2;
                        int idx4 = actualCharIndex * 6 + 3;
                        int idx5 = actualCharIndex * 6 + 4;
                        int idx6 = actualCharIndex * 6 + 5;
